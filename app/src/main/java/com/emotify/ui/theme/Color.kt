...
// Bảng màu chính cho Dark Mode (Chủ đạo cho app nhạc)
val DarkBackground = Color(0xFF121212) // Nền chính cực tối
...
// Bảng màu dự phòng cho Light Mode (Nếu người dùng bật chế độ sáng)
